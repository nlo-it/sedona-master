...
2. **Пояснения для учащихся**
  ...
  * 2.1 В макетах есть скрытые слои со всплывающими окнами. Такие слои в блоке слоёв Photoshop выделены синим цветом.
...
3. **Обязательные требования**
  ...
  * 3.7 При достижении `1200px` сетка перестаёт масштабироваться дальше, слева и справа от неё появляется серый фон, на который сайт бросает лёгкую тень.
